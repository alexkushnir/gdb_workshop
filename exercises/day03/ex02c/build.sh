#!/usr/bin/env bash
# exercises/day03/ex02c/build.sh
# Usage: bash build.sh [--full-build | --build-only | --clean | --tsan]
...
#   --tsan         Build with ThreadSanitizer enabled
...
echo "Build successful: ${BUILD_DIR}/ex02c"
