...
echo "  Handling debug symbols for ex01..."
# Extract symbols into ex01.debug
objcopy --only-keep-debug "${BUILD_DIR}/ex01" "${BUILD_DIR}/ex01.debug"
# Strip all symbols from ex01
strip --strip-debug --strip-unneeded "${BUILD_DIR}/ex01"

echo "  ex01 built, symbols extracted and executable stripped."
