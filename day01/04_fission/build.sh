#!/usr/bin/env bash
# 04_fission/build.sh
# Usage: bash build.sh [--full-build | --build-only | --clean] [--split-dwarf]
...
#   --split-dwarf  Enable split-DWARF / fission (configure stage)
