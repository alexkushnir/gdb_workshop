...
echo "2. Run this ProcMon command:"
echo "   sudo procmon -p $SIM_PID"
echo ""
echo "What to look for in ProcMon:"
echo "- Failed 'open' calls for config.json (ENOENT)"
echo "- 'write' calls to app.log"
echo "- 'unlink' calls for the /tmp transient file"
echo "=================================================="
echo ""
